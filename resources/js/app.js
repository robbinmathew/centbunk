...
function buildSummaryPanel() {
    ...
    addReportPanel("api/result/partyBalanceSummary", {"start" : (bunkCache.infos.todayDate - 30), "end" : bunkCache.infos.todayDate}, "Fuels sale summary (Last 30 days)", summaryPanel , ' L', 1, "chart",600);
