...
function buildPartyViewerPopup(stores, myMask) {
    ...
    var popUp = Ext.create('Ext.window.Window', {
        ...
        items:[{
                                   ...
                                   vertical: true,
                                   items: [
                                       { boxLabel: 'Active Only', name: 'reportTypeGroup', inputValue: 'ActiveOnly', checked: true},
                                       { boxLabel: 'Show All', name: 'reportTypeGroup', inputValue: 'All'}
                                   ],
                                   listeners: {
                               ...
                               },getGrid(stores[0], "Credit parties", "party-viewer-partiesGrid", statusCombo),
